 ...
 * @Link           https://leetcode.com/explore/interview/card/top-interview-questions-easy/99/others/565/
...
int main(int argc, char** argv) {
    uint32_t input = 0b10000000000000000000000000001011;
